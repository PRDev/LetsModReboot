...
public class IronOven extends BlockContainer
{
    ...
    {
        return Item.getItemFromBlock(ModBlocks.ironOven);
    }
    ...
    {
        this.blockIcon = iconRegister.registerIcon(Reference.MODID + ":" +"IronFurnace_side");
        this.field_149936_O = iconRegister.registerIcon(this.field_149932_b ? Reference.MODID + ":" +"IronFurnace_front_active" : Reference.MODID + ":" +"IronFurnace_front_idle");
        this.field_149935_N = iconRegister.registerIcon(Reference.MODID + ":" +"IronFurnace_side");
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        else if (!par5EntityPlayer.isSneaking())
        {
            ...
            if (var10 != null)
            {
                par5EntityPlayer.openGui(LetsModReboot.instance, 1, par1World, par2, par3, par4);
            }
            return true;
        }
        else
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, ModBlocks.ironOvenActive);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, ModBlocks.ironOven);
        }
