...
public class GuiIronOven extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private TileEntityIronOven tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public GuiIronOven(InventoryPlayer par1InventoryPlayer, TileEntityIronOven par2TileEntityIronOvenIdle)
    {
        super(new ContainerIronOven(par1InventoryPlayer, par2TileEntityIronOvenIdle));
