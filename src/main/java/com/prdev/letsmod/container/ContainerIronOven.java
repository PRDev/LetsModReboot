...
import com.prdev.letsmod.help.IronOvenRecipes;
import com.prdev.letsmod.help.SlotIronOven;
...
public class ContainerIronOven extends Container
{
    private TileEntityIronOven tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;
    private static final String __OBFID = "CL_00001748";

    public ContainerIronOven(InventoryPlayer par1InventoryPlayer, TileEntityIronOven par2TileEntityIronOven)
    {
        ...
        this.addSlotToContainer(new SlotIronOven(par1InventoryPlayer.player, par2TileEntityIronOven, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (IronOvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityIronOven.isItemFuel(itemstack1))
                {
